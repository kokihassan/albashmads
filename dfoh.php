<?php
ob_start();
$API_KEY = '1841312531:AAH9xOmI778XJKSvnxSyULG4NGTN6ZNlFV4';
...
$admmm = "1116526399";
$tbbots = "cptsha8"; 
$Dev = array("$admmm","1470877209");// حط ايدي مطور ثاني بدل الاصفار
@$channel = "cptsha8";
@$token = API_KEY;
$buyy = "@$tbbots";
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'• اصنع بوت ، لك 🔱','url'=>'https://t.me/cptsha8']],
               ]
        ])
    ]);
}
...
🦁┇[TeaM ALBASHA](https://t.me/cptsha8)
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
  ...
  'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"مطور بوت $namebot 👮",'url'=>"t.me/ARLOUefg"]],
]])
]);
}}}
...
bot('sendsticker',[
'chat_id'=>$chat_id,
'sticker'=>"https://t.me/cptsha8/5976",
 'reply_to_message_id'=>$message_id,
]);}}}
...
••┉┉┉┉┉┉┉┉┉┉┉┉┉•• 
💢❉ قم بمراسله المطور لصنع بوت مدفوع خاص بك › @cptsha8 ✅
📮✣ لصنع بوتك مجاني من مصنع بوتات روكي ‹ @cptsha8 › 👨🏽‍💻
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
